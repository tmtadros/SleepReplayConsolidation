function [ accuracy1, accuracy2 ] = run_icarl_cifar(task_order, do_sleep, memory, epochs, distillation, herding )
...
if memory == 50 || memory == 100
    x = [95.654279 0.018482 0.003361 29.299352 32.774902 20.531455 30.435772];
elseif memory == 200 || memory == 500
    x = [142.055446 0.100000 0.000001 20.851448 0.318765 0.000000 0.100000];
else 
    x = [222.445416 0.100000 0.000001 23.976169 0.318765 0.000000 0.100000]; % k = 1000
end	
