function [ accuracy1,accuracy2 ] = run_sleep_with_variable_task2_length(task2_num_epochs)
...
er = nntest(nn1, test_x1, test_y1);
accuracy1 = (1-er)*100
er = nntest(nn1, test_x2, test_y2);
accuracy2 = (1-er)*100
...
er = nntest(Snn, test_x1, test_y1);
accuracy1 = (1-er)*100
er = nntest(Snn, test_x2, test_y2);
accuracy2 = (1-er)*100
