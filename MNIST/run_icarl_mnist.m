function [ accuracy1, accuracy2 ] = run_icarl_mnist(task_order, do_sleep, memory, epochs, distillation, herding)
...
if memory == 50
    x = [95.654279 0.058705 0.009112 27.477005 21.155469 22.567029 19.001764];
elseif memory == 100 || memory == 200 || memory == 500
    x = [114.365720 0.042289 0.005498 38.451454 22.198208 6.893450 4.253433];
else
    x = [27.393650 0.019093 0.060217 9.625520 34.737610 31.296881 2.023822];
end
